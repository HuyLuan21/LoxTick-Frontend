...
export default function VideoPlayer({ video }: { video: Video }) {
  ...
  // Seek khi click vào progress bar
  ...
  const toggleMute = (e: React.MouseEvent) => {
    e.stopPropagation(); // không trigger togglePlay
    const el = videoRef.current;
    if (!el) return;
    el.muted = !el.muted;
    setIsMuted(el.muted);
  ...
  return (
    ...
    >
      ...
      {/* Pause icon — hiện giữa màn hình khi pause */}
      {!isPlaying && (
